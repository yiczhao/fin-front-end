        ...
        <div class="content business-lists" slot="content">
            <div class="panel panel-flat">
                <ul class="tab-bor">
                    ...
                    <li data-ksa="merchant_manage" class="active"><a v-link="{name:'business-lists'}">商户列表</a></li>
                ...
                <div class="heading">
                    ...
                    <div class="heading-right">
                        <form class="form-inline manage-form">
                            ...
                            <input type="text" class="form-control" v-model="defaultData.endValue"
                                   v-limitnumber="defaultData.endValue" placeholder="佣金值">
                            <select class="form-control" v-model="defaultData.companyId"
                                    @change="getCity(defaultData.companyId)">
                                <option value="">全部分公司</option>
                                <option v-for="(index,n) in companylists" v-text="n.name"
                    ...
                    <div class="heading-middle">
                        <a class="btn btn-info add-top" style="margin-left: -13px;" @click="checkNew"
                           data-ksa="merchant_manage.search">查询</a>
                    </div>
                </div>
                ...
                >
                    <div class="modal-body" style="padding-top: 0;">
                        ...
                        <div v-if="relist!=''" class="mt35" style="margin-top: 5px;">
                            <div v-if="relist!=''"><span>账户名：{{relist[0].accountName}}</span><span>账  号：{{relist[0].accountNumber}}</span>
                            </div>
                            <div v-if="relist!=''"><span>开户行：{{relist[0].bankName}}</span><span>提入行号：{{relist[0].bankNumber}}</span>
                            </div>
                        ...
                        <form novalidate>
                            <div class="modal-body member_rules_modal-body">
                                <div class="form-group">
                                    ...
                                    <input v-validate:accountName="['required']" v-model="updateList.accountName"
                                           class="form-control" type="text" placeholder="账户名">
                                </div>
                                <div class="form-group">
                                    <label class="w28"><i>*</i>账 号：</label>
                                    <input v-validate:accountNumber="['required']" v-model="updateList.accountNumber"
                                           class="form-control" type="text" placeholder="账 号">
                                </div>
                                <div class="form-group">
                                    <label class="w28"><i>*</i>开户行：</label>
                                    <input v-validate:bankName="['required']" v-model="updateList.bankName"
                                           class="form-control" type="text" placeholder="开户行">
                                </div>
                                <div class="form-group">
                                    <label class="w28"><i>*</i>建行否：</label>
                                    <input type="radio" id="one" value="1" v-model="updateList.isCcb"
                                           v-validate:isCcb="['required']">
                                    <label class="w28" for="one">是</label>
                                    <input type="radio" id="two" value="0" v-model="updateList.isCcb"
                                           v-validate:isCcb="['required']">
                                    <label class="w28" for="two">否</label>
                                </div>
                                <div class="form-group" v-if="updateList.isCcb!=1">
                                    <label class="w28"><i>*</i>提入行号：</label>
                                    <input v-validate:bankNumber="['required']" v-limitnumber="updateList.bankNumber"
                                           v-model="updateList.bankNumber" class="form-control" type="text"
                                           placeholder="提入行号">
                                    <a href="https://www.hebbank.com/corporbank/otherBankQueryWeb.do" target="_blank">查询行号</a>
                                </div>
                                <div class="form-group">
                                    <label class="w28"><i>*</i>划付周期：</label>
                                    <select class="form-control" v-model="updateList.settlementCycle"
                                            v-validate:settlementCycle="['required']">
                                ...
                                <div class="form-group">
                                    ...
                                    <input @keyup="numberMax($event)" v-validate:subsidyRate="['required']"
                                           v-model="updateList.subsidyRate" class="form-control" type="number"
                                           placeholder="0~100">%
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="updateList.specialRemarks" class="form-control" type="text"
                                           placeholder="目前只有中石化商户需要在此填写商户编号">
                                </div>
                                <div class="form-group tc">
                                    <button type="button" @click="updateTrue(updateList)" class="btn btn-primary"
                                            data-ksa="merchant_manage.update">保存
                                    </button>
                                </div>
                                <div class="form-group tc">
                                    <span v-show="(!$vali.valid&&updataerror)|| errortext!=''"
                                          class="validation-error-label" v-text="errortext"></span>
                                </div>
                            </div>
                        </form>
                    </validator>
