                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr role="row" v-for="(index,trlist) in zdlists" v-bind:class="{'odd':(index%2==0)}">
                                    ...
                                    <td>
                                        <a v-link="{name:'contract-management',params:{'contractId':trlist.id,'contractName':trlist.accountName,'contractCity':trlist.cityName,'contractCompanyName':trlist.subCompanyName,'contractCompanyName':trlist.subCompanyID}}" data-ksa="">管理</a>
                                    </td>
