    ...
    <index :title="'财务指标分析表（分）'"
        ...
        <div class="content financial-index-branch" slot="content">
           	<div class="panel panel-flat">
           	 	<ul class="tab-bor">
                    <li data-ksa="target_total.search"     ><a v-link="{name:'financial-index-total'}">财务指标分析表（总）</a></li>
                    <li data-ksa="target_branch.search"     class="active"><a>财务指标分析表（分）</a></li>
                ...
                <div class="heading">
                    ...
                    <div class="heading-middle">
                            <a class="btn btn-info add-top"  data-ksa="target_branch.search" @click="initList()" >查询</a>
                    </div>
                </div>
